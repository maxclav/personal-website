    ...
    <div id="resume">
      <article class="resume-wrapper text-center position-relative">
          <div class="resume-wrapper-inner mx-auto text-left bg-white shadow-lg">
            <ResumeHeader />
            <h2 class="resume-section-title text-uppercase font-weight-bold pb-3 mb-3" style="text-align: center;">
              <v-icon>mdi-coffee-maker</v-icon> {{ dictionary['wip'][currentLanguage] }}
            </h2>
            <div class="row">
              <ResumeMain />
              <ResumeSideBar />
...
<script>
  import ResumeHeader from './Header/Header';
  import ResumeMain from './Main/Main';
  import ResumeSideBar from './SideBar/SideBar';
  import ResumeFooter from './Footer/Footer';
...
.custom-select:focus {
  border-color: #7e8da3;
  outline: 0;
  box-shadow: 0 0 0 0.2rem rgba(126, 141, 163, 0.5);
}
